        ...
        Child, VGroup,
          Child, VGroup,
            ...
            Child, ColGroup(2),
              ...
              Child, data->o[MCP_UndoSize] = SliderObject,
              ...
              Child, data->o[MCP_TabSize] = SliderObject,
              ...
              Child, HGroup,
                ...
                Child, data->o[MCP_Smooth] = MUI_MakeObject(MUIO_Checkmark, NULL),
                Child, HSpace(0),
              End,
              Child, TxtLabel(tr(MSG_Label_SelectPointer), 0),
              Child, HGroup,
                MUIA_ShortHelp, tr(MSG_HELP_SelectPointer),
                Child, data->o[MCP_SelectPointer] = MUI_MakeObject(MUIO_Checkmark, NULL),
                Child, HSpace(0),
              End,
            End,
            Child, VSpace(0),
...
//            MUIA_VertWeight, 0,
            ...
            Child, data->o[MCP_Frame] = MUI_NewObject("Popframe.mui",
            ...
            Child, data->o[MCP_Background] = MUI_NewObject("Popimage.mui",
          ...
          Child, HGroup,
            ...
            Child, data->o[MCP_SeparatorShine] = PoppenObject,
            ...
            Child, data->o[MCP_SeparatorShadow] = PoppenObject,
...
//            MUIA_VertWeight, 0,
            ...
            Child, ColGroup(2),
              ...
              Child, PopaslObject,
                MUIA_Popstring_String, data->o[MCP_NormalFont] = BetterStringObject,
                  StringFrame,
                  MUIA_CycleChain, TRUE,
                End,
              ...
              Child, PopaslObject,
                MUIA_Popstring_String,  data->o[MCP_FixedFont] = BetterStringObject,
                  StringFrame,
                  MUIA_CycleChain, TRUE,
                End,
...
//            MUIA_VertWeight, 0,
            ...
            Child, data->o[MCP_CursorColor] = PoppenObject,
            ...
            Child, data->o[MCP_MarkedColor] = PoppenObject,
            ...
            Child, data->o[MCP_InactiveColor] = PoppenObject,
            ...
            Child, data->o[MCP_CursorWidth] = NewObject(widthslider_mcc->mcc_Class, NULL,
              MUIA_Numeric_Min, 1,
              MUIA_Numeric_Max, 6,
            ...
            Child, data->o[MCP_BlinkSpeed] = NewObject(speedslider_mcc->mcc_Class, NULL,
              MUIA_Numeric_Min, 0,
              MUIA_Numeric_Max, 20,
            ...
            Child, HGroup,
              ...
              Child, data->o[MCP_InactiveCursor] = MUI_MakeObject(MUIO_Checkmark, NULL),
              Child, HSpace(0),
            End,
          End,
      ...
      Child, VGroup,
        ...
        Child, data->o[MCP_Keybindings] = ListviewObject,
          ...
          MUIA_Listview_List, keylist = ListObject,
            ...
            MUIA_List_Format,         "P=\33r W=100, P=\33c,",
//            MUIA_List_Format, "P=\33r W=100, P=\33c NoTB NoBar,",
...
//              MUIA_Poplist_Array,     data->functions,
      ...
      Child, VGroup,
        ...
        Child, ColGroup(3),
          ...
          Child, data->o[MCP_LookupExeType] = CycleObject,
            MUIA_Cycle_Entries, data->execution,
            MUIA_Weight, 0,
            MUIA_CycleChain, TRUE,
          End,
          Child, data->o[MCP_LookupCommand] = BetterStringObject, StringFrame,
            MUIA_ShortHelp, tr(MSG_HELP_SPELLCHECKER_LOOKUP_CMD),
            MUIA_CycleChain, TRUE,
          End,
          Child, TxtLabel(tr(MSG_Label_SuggestCmd), 0),
          Child, data->o[MCP_SuggestExeType] = CycleObject,
            MUIA_Cycle_Entries, data->execution,
            MUIA_Weight, 0,
            MUIA_CycleChain, TRUE,
          End,
          Child, data->o[MCP_SuggestCommand] = BetterStringObject, StringFrame,
        ...
        Child, ColGroup(2),
          ...
          Child, data->o[MCP_TypeNSpell] = MUI_MakeObject(MUIO_Checkmark, NULL),
          Child, TxtLabel(tr(MSG_Label_LookupWords), 1000),
          Child, data->o[MCP_CheckWord] = MUI_MakeObject(MUIO_Checkmark, NULL),
          MUIA_Weight, 0,
        End,
...
*/
    ...
    set(data->o[MCP_BlockQual], MUIA_ShortHelp, tr(MSG_HelpBubble_BlockQual));
    set(data->o[MCP_TypeNSpell], MUIA_ShortHelp, tr(MSG_HelpBubble_TypeNSpell));
    set(data->o[MCP_CheckWord], MUIA_ShortHelp, tr(MSG_HelpBubble_CheckWord));
    ...
    DoMethod(data->o[MCP_LookupCommand], MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime, MUIV_Notify_Window, 3, MUIM_Set, MUIA_Window_ActiveObject, data->o[MCP_SuggestCommand]);
...
//    DoMethod(data->hotkey, MUIM_Notify, MUIA_String_Contents, MUIV_EveryTime, button, 3, MUIM_Set, MUIA_Selected, FALSE);
    ...
    set(data->o[MCP_SelectPointer], MUIA_Disabled, xget(editor, MUIA_PointerType) != MUIV_PointerType_Normal);
  }
